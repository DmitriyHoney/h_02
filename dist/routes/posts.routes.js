...
router.put('/:postId/like-status', auth_middleware_1.getUserByRefreshJWT, auth_middleware_1.authMiddlewareJWT, ...posts_middleware_1.createLikeForPostBody, middlewares_1.validatorsErrorsMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _j, _k, _l, _m, _o;
    // @ts-ignore
